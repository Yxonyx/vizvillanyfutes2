    ...
    <div className="min-h-screen">
            ...
            <div className="text-white space-y-2 text-center flex flex-col items-center lg:hidden">
              ...
              <div className="w-full pt-3 border-t border-white/10 mt-1 flex justify-center">
                <div className="grid grid-cols-2 gap-y-3 gap-x-6 sm:gap-x-12 w-fit">
                  {(role === 'contractor' ? [
                    { icon: <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />, text: '0% jutalék' },
                    { icon: <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />, text: 'Napi friss leadek' },
                    { icon: <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />, text: 'Rugalmas elfogadás' },
                    { icon: <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />, text: 'Azonnali értesítés' },
                  ] : [
            ...
            <div className="hidden lg:flex flex-col items-start space-y-6 text-left pr-8 w-full max-w-[700px]">
              {role === 'contractor' ? (
                <>
                  ...
                  <p className="text-lg text-blue-100/90 max-w-lg leading-relaxed font-light">
                    ...
                    fogadd el a leadeket, és építsd az ügyfélköröd a platformon keresztül.
                  </p>
                </>
              ) : (
                <>
              ...
              <div className="pt-8 w-full mt-auto">
                {role === 'contractor' ? (
                  <div className="flex items-center gap-3 mb-6 flex-wrap sm:flex-nowrap">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-vvm-yellow-500/20 rounded-full flex items-center justify-center">
                        <MapPin className="w-5 h-5 text-vvm-yellow-400" />
                      </div>
                      <div>
                        <div className="text-[1.5rem] font-black text-white leading-none">Budapest + Pest megye</div>
                        <div className="text-sm text-blue-100/70 mt-0.5">Teljes lefedettség</div>
                      </div>
                    </div>
                  </div>
                ) : (
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
                  {(role === 'contractor' ? [
                    { icon: <CheckCircle className="w-5 h-5 text-emerald-400" />, text: '0% jutalék' },
                    { icon: <CheckCircle className="w-5 h-5 text-emerald-400" />, text: 'Napi friss leadek' },
                    { icon: <CheckCircle className="w-5 h-5 text-emerald-400" />, text: 'Rugalmas elfogadás' },
                    { icon: <CheckCircle className="w-5 h-5 text-emerald-400" />, text: 'Azonnali értesítés' },
                  ] : [
      ...
      {role === 'contractor' ? (
        ...
        <>
          ...
          <section className="py-8 bg-white border-b border-gray-100">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Link href="/contractor/dashboard" className="bg-vvm-blue-50 hover:bg-vvm-blue-100 rounded-2xl p-5 text-center transition-colors group">
                  <Search className="w-7 h-7 text-vvm-blue-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  <div className="text-sm font-bold text-vvm-blue-900">Munkák böngészése</div>
                  <div className="text-xs text-slate-500 mt-0.5">Friss megrendelések</div>
                </Link>
                <Link href="/fiok" className="bg-slate-50 hover:bg-slate-100 rounded-2xl p-5 text-center transition-colors group">
                  <User className="w-7 h-7 text-slate-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  <div className="text-sm font-bold text-slate-800">Profilom</div>
                  <div className="text-xs text-slate-500 mt-0.5">Adatok, beállítások</div>
                </Link>
                <Link href="/contractor/topup" className="bg-amber-50 hover:bg-amber-100 rounded-2xl p-5 text-center transition-colors group">
                  <Award className="w-7 h-7 text-amber-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  <div className="text-sm font-bold text-slate-800">Kredit feltöltés</div>
                  <div className="text-xs text-slate-500 mt-0.5">Egyenleg kezelés</div>
                </Link>
                <Link href="/contractor/profile" className="bg-emerald-50 hover:bg-emerald-100 rounded-2xl p-5 text-center transition-colors group">
                  <Briefcase className="w-7 h-7 text-emerald-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  <div className="text-sm font-bold text-slate-800">Szakterületek</div>
                  <div className="text-xs text-slate-500 mt-0.5">Területek, szakmák</div>
                </Link>
              </div>
            </div>
          </section>
          ...
          <section className="py-12 md:py-16 bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-600 text-white">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                <Gift className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold font-heading mb-4 tracking-tight">
                Hívd meg szakember <span className="text-yellow-300">ismerősöd!</span>
              </h2>
              <p className="text-lg text-emerald-100 mb-6 max-w-xl mx-auto leading-relaxed">
                Minden meghívott szakember után <strong className="text-white">+5.000 Ft kreditet</strong> kapsz a fiókodon. 
                Az ismerősöd is kap <strong className="text-white">10.000 Ft</strong> induló kreditet!
              </p>
              <Link 
                href="/ajanlo-program" 
                className="bg-white text-emerald-700 font-bold text-lg py-4 px-8 rounded-xl hover:bg-emerald-50 transition-colors inline-flex items-center justify-center gap-2 shadow-lg"
              >
                <Send className="w-5 h-5" />
                Részletek & meghívólink
              </Link>
            </div>
          </section>
          ...
          <section className="py-12 md:py-16 bg-white">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                <h2 className="text-3xl sm:text-4xl font-bold font-heading text-vvm-blue-900 mb-3">Hogyan működik?</h2>
                <p className="text-slate-500 text-lg">3 egyszerű lépés a munkáig</p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { step: '1', icon: <Search className="w-6 h-6" />, title: 'Böngészd a munkákat', description: 'Az ügyfelek feladják a problémájukat a térképen. Te látod az elérhető munkákat a környékeden.', color: 'bg-vvm-blue-500' },
                  { step: '2', icon: <CheckCircle className="w-6 h-6" />, title: 'Jelentkezz rá', description: 'Ami érdekel, arra kreditből jelentkezel. Az ügyfél megkapja az elérhetőséged és felveszi veled a kapcsolatot.', color: 'bg-emerald-500' },
                  { step: '3', icon: <Star className="w-6 h-6" />, title: 'Végezd el & értékelnek', description: 'Egyeztess az ügyféllel közvetlenül. A jó értékelések több munkát hoznak neked!', color: 'bg-amber-500' },
                ].map((item, i) => (
                  <div key={i} className="text-center">
                    <div className={`w-14 h-14 ${item.color} rounded-2xl flex items-center justify-center text-white mx-auto mb-4 shadow-lg`}>{item.icon}</div>
                    <div className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">{item.step}. lépés</div>
          ...
          {/* Bottom CTA */}
          <section className="py-12 bg-gradient-to-br from-vvm-blue-800 via-vvm-blue-700 to-vvm-blue-900 text-white">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold font-heading mb-4">Nézzük, milyen munkák várnak rád!</h2>
              <p className="text-blue-200 mb-6">Böngészd a legfrissebb megrendeléseket a környékeden.</p>
              <Link 
                href="/contractor/dashboard" 
                className="inline-flex items-center gap-2 bg-vvm-yellow-500 hover:bg-vvm-yellow-400 text-gray-900 font-bold text-lg py-4 px-10 rounded-xl transition-all transform hover:scale-105 shadow-[0_4px_20px_rgba(250,204,21,0.3)]"
              >
                <Search className="w-6 h-6" />
                Munkák böngészése
              </Link>
        ...
        /* ====== CUSTOMER/GUEST CONTENT (Original) ====== */
        <>
