...
const blogPosts: Record<string, {
  ...
  '1': {
    ...
    content: [
      ...
      'Ha gyanítja, hogy befagyott a cső (nem jön víz, vagy szokatlan zajokat hall), azonnal keressen szakembert a platformon! A VízVillanyFűtés partnerei SOS kiszállást is vállalnak.',
    ],
    category: 'viz',
  ...
  '2': {
    ...
    content: [
      ...
      '5. Ha nem találja a hibát, keressen szakembert a platformon!',
  ...
  '4': {
    ...
    content: [
      ...
      'A termosztát szelep felelős a víz áramlásának szabályozásáért. Ha elakad (általában nyári állásban), a radiátor nem kap meleg vizet. Próbálja meg óvatosan mozgatni a szelep tűjét, vagy keressen szakembert a platformon.',
      ...
      '## Megelőzés',
      'Évente egyszer érdemes átnézetni a fűtési rendszert. A platformon található szakemberek teljes körű fűtésrendszer karbantartást végeznek – kérjen ajánlatot most!',
    ],
    category: 'futes',
    categoryLabel: 'Fűtés',
    author: 'Tóth Gábor',
  ...
  '5': {
    ...
    content: [
      ...
      'Ha a fenti módszerrel nem sikerül megtalálni a hibás készüléket, vagy a Fi-relé készülékek nélkül is kiold, akkor a hiba a vezetékrendszerben van. Ilyenkor AZONNAL keressen villanyszerelőt a platformon!',
      '## Fontos figyelmeztetés',
      'SOHA ne iktatja ki a Fi-relét, és ne próbálja áthidalni! Az Ön és családja életét védi. Inkább keressen szakembert – a platformon elérhető villanyszerelők SOS kiszállást is vállalnak.',
    ],
    category: 'villany',
    categoryLabel: 'Villanyszerelés',
    author: 'Nagy Péter',
  ...
  '6': {
    ...
    content: [
      ...
      'Először próbálkozzon pumpa (vákuumos) módszerrel. Ha nem segít, ne használjon agresszív vegyszereket – inkább keressen szakembert a platformon! A szakszerű gépi duguláselhárítás gyorsan és tisztán megoldja a problémát.',
    ],
    category: 'viz',
    categoryLabel: 'Vízszerelés',
    author: 'Kovács István',
